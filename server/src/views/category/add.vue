    ...
    <div class="mr-10 ml-10 mb-20">
      <el-form ref="params" :model="params" label-width="84px">
        <div v-show="activeIndex == 0">
          ...
          <el-form-item class="flex" label="通栏图片">
            <el-upload
            ...
            >
              ...
              <el-image style="width: 100%" :src="params.tong" />
            </el-popover>

            <el-input class="ml-10 flex-1" v-model="params.tong"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async upload(file) {
      ...
      if (res.code === 200) {
        this.params.tong = res.data.path;
      }
    },
    createPinyin(v) {
