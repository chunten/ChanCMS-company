  ...
  <div class="content-wrap">
    ...
    >
      ...
      <el-table-column
        ...
        width="140"
      ></el-table-column>
      <el-table-column  align="center" label="通栏图片">
        <template #default="scope">
          <el-image v-if="scope.row.tong"
      ...
      <el-table-column prop="pinyin" label="栏目标识" width="80">
      ...
      <el-table-column prop="listView" label="列表模板"></el-table-column>
      <el-table-column prop="articleView" label="内容模板"></el-table-column>
      ...
      <el-table-column fixed="right" label="操作" width="160">
        <template #default="scope">
          ...
          <el-button
            :icon="Delete"
            circle
            @click="handleDelDefore(scope.row)"
          ></el-button>
        </template>
      </el-table-column>
    </el-table>
